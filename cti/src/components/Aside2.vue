<template>
    <aside class="aside-container">
      ...
      <div class="nav">
        ...
        <div class="user-panel">
          <button class="nav-button" @click="navigate('investigadores')">
            <img src="../assets/invest2.png" alt="Investigadores" class="nav-icon" />
            <span>Investigadores</span>
          </button>
          
          <button class="nav-button" @click="navigate('balance')">
            <img src="../assets/curriculo.png" alt="Condecoraciones" class="nav-icon" />
            <span>Balance</span>
          </button>
        </div>
      </div>
    ...
    methods: {
      navigate(section) {
        ...
        if (section === 'curriculo') {
          this.$router.push('/curriculo2');
        } else if (section === 'inicio') {
          this.$router.push('/home_trab');
        }else if (section === 'articulos') {
          this.$router.push('/articulo2');
        }else if (section === 'libros') {
          this.$router.push('/libro2');
        }else if (section === 'monografias') {
          this.$router.push('/monografia2');
        }else if (section === 'premios') {
          this.$router.push('/premios2');
        }else if (section === 'reconocimientos') {
          this.$router.push('/reconocimiento2');
        }else if (section === 'investigadores') {
